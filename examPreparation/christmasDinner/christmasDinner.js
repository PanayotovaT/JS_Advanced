class ChristmasDinner {
    ...
    showAttendance() {
        ...
        return Object
            .entries(this.guests)
            .reduce((acc, [guestName, dish]) => acc.concat([`${guestName} will eat ${dish}, which consists of ${this.dishes.find(d => d.recipeName == dish).productsList.join(', ')}`]),[]).join('\n');
        //vmesto concat:
        //[...acc, `${guestName} will eat...`]
    }
}
